...
package object parser {
  ...
  /**
   * Parse the specified nesT file. This method locates the file, parses it, and reports parse
   * errors. It does not do any type checking on the resulting nesT AST.
   * 
   * @param source The name of the nesT file to parse. Names with paths (absolute or relative)
   * should be treated "as is," and names without paths should be located using some sort of
   * configurable search method.
   * 
   ...
   * 
   * @return The abstract syntax tree of the nesT inclusion.
   */
