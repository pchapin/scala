...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    @ModuleType("""{checksumType <: UInt32}
                   <;>
                   { ; }""")
    val resultModule = BootShimC        +>
                       formattingModule +>
                       getChecksummer(size, desiredChecksumType)
    resultModule.image()
  }
