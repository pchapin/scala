...
object Main {
  ...
  import edu.uvm.scalaness.runtime.{NamedProgramComponent, MininessComponent, Parser, ProgramComponentWrapper}
   ...
   */
  class InitialConstantsC(flashCountType: MetaType[Int32], blinkCount: Int32) extends MininessComponent {
    /////////
   ...
   */
  class BlinkC(flashCountType: MetaType[Int32], periodType: MetaType[Int16], period: Int16) extends MininessComponent {
    /////////
    // Code generated by the Scalaness compiler.
    /////////
  ...
  def main(args: Array[String]) {
    ...
    val blinkModule = new BlinkC(desiredType, new MetaType[Int16](MininessTypes.Int8), new Int8(100))
