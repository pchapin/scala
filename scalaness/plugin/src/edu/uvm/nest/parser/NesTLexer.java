// $ANTLR 3.4 NesT.g 2013-10-14 15:25:34
...
public class NesTLexer extends Lexer {
    ...
    public final void mIMPLEMENTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:41:16: ( 'implementation' )
            // NesT.g:41:18: 'implementation'
            {
    ...
    public final void mINTERFACE() throws RecognitionException {
        try {
            int _type = INTERFACE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:46:11: ( 'interface' )
            // NesT.g:46:13: 'interface'
            {
            match("interface"); 
    ...
    public final void mNX_STRUCT() throws RecognitionException {
        try {
            int _type = NX_STRUCT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:64:11: ( 'nx_struct' )
            // NesT.g:64:13: 'nx_struct'
            {
            match("nx_struct"); 
    ...
    public final void mNX_UINT16_T() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:65:13: ( 'nx_uint16_t' )
            // NesT.g:65:15: 'nx_uint16_t'
            {
            match("nx_uint16_t"); 
    ...
    public final void mNX_UINT32_T() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:66:13: ( 'nx_uint32_t' )
            // NesT.g:66:15: 'nx_uint32_t'
            {
            match("nx_uint32_t"); 
    ...
    public final void mNX_UINT8_T() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:67:12: ( 'nx_uint8_t' )
            // NesT.g:67:14: 'nx_uint8_t'
            {
            match("nx_uint8_t"); 
    ...
    public final void mPROVIDES() throws RecognitionException {
        try {
            int _type = PROVIDES;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:73:10: ( 'provides' )
            // NesT.g:73:12: 'provides'
            {
            match("provides"); 
    ...
    public final void mUINT16_T() throws RecognitionException {
        try {
            int _type = UINT16_T;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:88:10: ( 'uint16_t' )
            // NesT.g:88:12: 'uint16_t'
            {
            match("uint16_t"); 
    ...
    public final void mUINT32_T() throws RecognitionException {
        try {
            int _type = UINT32_T;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:89:10: ( 'uint32_t' )
            // NesT.g:89:12: 'uint32_t'
            {
            match("uint32_t"); 
    ...
    public final void mUNSIGNED() throws RecognitionException {
        try {
            int _type = UNSIGNED;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:91:10: ( 'unsigned' )
            // NesT.g:91:12: 'unsigned'
            {
            match("unsigned"); 
    ...
    public final void mRAW_IDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:730:5: ( ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // NesT.g:730:10: ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:736:5: ( '\"' ( options {greedy=false; } : . )* '\"' )
            // NesT.g:736:10: '\"' ( options {greedy=false; } : . )* '\"'
            {
            match('\"'); 

            // NesT.g:736:14: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mCHARACTER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:739:5: ( '\\'' ( options {greedy=false; } : . )* '\\'' )
            // NesT.g:739:10: '\\'' ( options {greedy=false; } : . )* '\\''
            {
            match('\''); 

            // NesT.g:739:15: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mCOMMENT1() throws RecognitionException {
        try {
            int _type = COMMENT1;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:745:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // NesT.g:745:10: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 



            // NesT.g:745:15: ( options {greedy=false; } : . )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mCOMMENT2() throws RecognitionException {
        try {
            int _type = COMMENT2;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // NesT.g:748:5: ( '//' ( options {greedy=false; } : . )* ( '\\r' | '\\n' ) )
            // NesT.g:748:10: '//' ( options {greedy=false; } : . )* ( '\\r' | '\\n' )
            {
            match("//"); 



            // NesT.g:748:15: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            // NesT.g:759:5: ( DEC_NUMBER | HEX_NUMBER )
            int alt7=2;
    ...
    public final void mDEC_NUMBER() throws RecognitionException {
        try {
            // NesT.g:763:5: ( ( DIGIT )+ ( NUMBER_SUFFIX )? )
            // NesT.g:763:10: ( DIGIT )+ ( NUMBER_SUFFIX )?
            {
            // NesT.g:763:10: ( DIGIT )+
            int cnt8=0;
            loop8:
    ...
    public final void mHEX_NUMBER() throws RecognitionException {
        try {
            // NesT.g:766:5: ( NUMBER_PREFIX ( HEX_DIGIT )+ ( NUMBER_SUFFIX )? )
            // NesT.g:766:10: NUMBER_PREFIX ( HEX_DIGIT )+ ( NUMBER_SUFFIX )?
            {
            mNUMBER_PREFIX(); 


            // NesT.g:766:24: ( HEX_DIGIT )+
            int cnt10=0;
            loop10:
            do {
                int alt10=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // NesT.g:772:5: ( '0' .. '9' | 'a' | 'b' | 'c' | 'd' | 'e' | 'f' | 'A' | 'B' | 'C' | 'D' | 'E' | 'F' )
            // NesT.g:
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'A' && input.LA(1) <= 'F')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
                input.consume();
    ...
    public final void mNUMBER_SUFFIX() throws RecognitionException {
        try {
            // NesT.g:778:5: ( ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' ) )
            // NesT.g:778:10: ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' )
            {
            // NesT.g:778:10: ( 'l' | 'L' | 'u' | 'U' | 'lu' | 'ul' | 'LU' | 'UL' )
            int alt12=8;
            switch ( input.LA(1) ) {
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt13) {
            ...
            case 92 :
                ...
                break;
            case 93 :
                // NesT.g:1:733: CHARACTER_LITERAL
                {
                mCHARACTER_LITERAL(); 
