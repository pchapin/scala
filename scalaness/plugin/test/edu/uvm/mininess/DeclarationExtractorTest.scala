...
class DeclarationExtractorTest extends TestHarness {
  ...
  private val MininessDeclarations = new File(testDeclarations, "Mininess")
  ...
  private def parseDeclaration(testCaseName: String) = {
    val testCase = new File(MininessDeclarations, testCaseName)
  ...
  private def extractDeclarationsCase(
    testCaseName   : String,
    expectedResults: Map[String, MininessTypes.Representation]) {
