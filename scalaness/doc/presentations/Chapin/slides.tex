...
\item \cemph{Sensor Networks}: A kind of embedded system with very limiting CPU, memory, and
  power constraints.
\end{citemize}
\stopslide
...
\begin{citemize}
\item \cemph{SpartanRPC}: An extension to the nesC programming language allowing for secure RPC.
...
\begin{tabular}{cc}
\scalebox{1.75}{\includegraphics{Figures/tmstruct.pdf}}
& 
\hspace{-10mm}
$
\begin{array}[b]{rcl}
...
\begin{citemize}
\item Wireless networks are \cemph{volatile}, \cemph{unreliable}, have \cemph{limited power}
  (must sleep).
...
\startslide{Acknowledgements}

I would like to acknowledge the help and advice I received from:

\centerline{Christian Skalka, Sean Wang, and Scott Smith}
\stopslide
...
\center{Scalaness: \cemph{https://github.com/pchapin/scala}}
\makeatother
\stopslide
