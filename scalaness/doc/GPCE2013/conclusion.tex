...
\cite{mainland12} 
% have each been promoted as effective foundations for embedded systems programming with type
% safety, but neither
are a foundations we build on; they do not address type specialization or dynamic type
construction.
%
% space saver cut - SS
%MetaHaskell does support heterogeneous language staging, the
%lower stage language is defined by a plug-in and several
...
programming for web applications. % We refer readers to our $\lb
% \textrm{ML} \rb$ paper \cite{FramedML} for a more
% complete review of meta programming systems/calculi.
...
We acknowledge Yu David Liu for early contributions to this work. 
