...
\input{NesT-Scalaness}
\input{Mininess-Implementation}   % The outline folds this into NesT-Scalaness.
\input{Scalaness-Implementation}  % The outline folds this into NesT-Scalaness.
\input{Evaluation}
\input{Conclusion}
...
\bibliography{../references-Meta,../references-WSN,../references-AccessControl,../references-Security,../references-Scala}
