...
% table above. I've never been completely happy with it, and the paper might be stronger without
% this mumbo-jumbo. That said, it might be valuable to say a few more words about why we think
% the numbers above are reasonable than I'm doing in the paragraph above.
...
% The directed diffusion application consumes 27826 bytes of ROM and 3105 bytes of RAM.
...
\note{Place holder for now\ldots}
