...
\note{Talk about nesT type rules and type checking? I need to reference Michael's thesis in here
  somewhere.}
...
Thus !MetaType! objects form a bridge between the Scala and nesC sides of the system. \note{Is
  it possible for wrappedType to not be a subtype of Tau? It would seem so. What happens in that
  case?}
