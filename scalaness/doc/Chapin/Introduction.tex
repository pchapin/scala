...
embedded systems. Here \newterm{trust management} refers to a general approach for authorizing
...
to address the needs of modern embedded systems. This \newterm{language-based} approach has the
...
they were created. \note{peter review this paragraph for clarity and correctness of intent}
...
a \note{should that 'a' be there?} different semantics that are not as expressive as this dissertation's approach.
...
The rest of this dissertation is organized as follows. Trust management systems are described, in
