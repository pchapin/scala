...
used to address the needs of modern embedded systems. This \newterm{language-based} approach has
...
\note{in this dissertation or in Scalaness or in SpartanRPC?}. The semantics of SDSI/SPKI have
...
security and has a \note{should that 'a' be there?} different semantics that are not as
