...
{
\begin{fpfig*}[t]{The Syntax of Scalaness}{figure-scalanesssyntax}
$$
...
{
\begin{fpfig*}[t]{Scalaness Module Semantics}{figure-jmodsemantics}
\begin{mathpar}
\inferrule[ModInst]
{
...
{
\begin{fpfig*}[t]{Scalaness Module Typing Rules}{figure-scalanesstyping}
\begin{mathpar}
\inferrule[ModT]
...
\inferrule[ModWireT]
{
 \Gamma \vdash \tt{e}_1 : \jmodt{\tpdecl_1'}{\margs{\tpdecl_1; \vpdecl_1}\lc\imports_1; \exportsty_1 \rc}\\
 \Gamma \vdash \tt{e}_2 : \jmodt{\tpdecl_2'}{\margs{\tpdecl_2; \vpdecl_2}\lc\imports_2; \exportsty_2 \rc} \\
\imports = (\imports_1 / \dom(\exportsty_2)) @ \imports_2 \\
}
{\Gamma \vdash \jwire{\tt{e}_1}{\tt{e}_2} : 
 \jmodt{\tpdecl_1' \maploosemerge \tpdecl_2'}{\margs{\tpdecl_1 \maploosemerge \tpdecl_2,\vpdecl_1 \maploosemerge \vpdecl_2} 
